...
class EditProfileController extends GetxController {
  ...
  Future<void> updateName(String name) async {
    final result = await _authRepo.updateUserData(name: name);
    result.fold(
  ...
  Future<void> updateEmail(String email) async {
    final result = await _authRepo.updateUserEmail(email);
    result.fold(
  ...
  Future<void> updateAddress(String address) async {
    final result = await _authRepo.updateUserData(address: address);
    result.fold(
      (failure) => snackbarError(message: failure.message),
      (updatedUser) {
  ...
  Future<void> updatePhone(String phone) async {
    final result = await _authRepo.updateUserData(phoneNumber: phone);
    result.fold(
      (failure) => snackbarError(message: failure.message),
      (updatedUser) {
