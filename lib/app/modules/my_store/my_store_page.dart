        ...
        return Stack(
          children: [
            RefreshIndicator(
              ...
              onRefresh: () async {
                await controller.refreshStoreData();
              },
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Ringkasan Penjualan', style: TStyle.head3),
                      ...
                      () => Wrap(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: _buildSummaryCard(
                              'Dibatalkan',
                              '${controller.totalCancelled.value}',
                              Colors.red,
                            ),
                          ),
                        ],
                    ...
                    const SizedBox(height: 16),
                    Text('Grafik Penjualan', style: TStyle.head3),
                    const SizedBox(height: 8),
                    _buildSalesChart(),
                  ],
                ),
                    ...
                    () => CircleAvatar(
                      ...
                      backgroundImage:
                          controller.store?.storeImageUrl.isNotEmpty ?? false
                              ...
                              : null,
                      child:
                          controller.store?.storeImageUrl.isEmpty ?? true
                              ? const Icon(
                                Icons.store,
                                size: 40,
                                color: Colors.grey,
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(title, style: TStyle.head5),
            const SizedBox(height: 8),
            Text(value, style: TStyle.head3),
          ],
        ),
      ),
    );
